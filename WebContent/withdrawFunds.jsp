...
<input type="hidden" id="status"  value="<%= request.getAttribute("status") %>">
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-lg-10 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"style="text-align:center">Withdraw Funds</h4>
                  <p class="card-description"style="text-align:center">
                    Withdraw funds from user account
                  </p>
                  <form class="forms-sample" method="post" action="withdrawfund">

                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Amount(In Rs.)</label>
                      <div class="col-sm-9">
                        <input type="number" class="form-control" id="exampleInputPassword2" placeholder="0.0" name="amount">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label">M-Pin</label>
                      <div class="col-sm-9">
                        <input type="password" class="form-control" id="exampleInputPassword2" placeholder="Password" name="mpin">
                      </div>
                    </div>
  ...
  <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    ...
    if(status=="Success"){
    	swal("Done","Fund withdraw Successfully","success");
    }
    else if(status=="unSuccess"){
    	swal("Sorry!","Unable to withdraw fund","error");
    }else if(status == "invalid"){
    	swal("Sorry!","Invalid Credentials","error");
    }else if(status == "insufficent"){
    	swal("Sorry!","Insufficent balance","error");
    }
    </script>
</body>
